...
One TypeScript-specific note: this package's `build()` does not write authority snapshots; if your own code adds an `authority` block to records, it is stored exactly as given and not redacted — keep it to hashes and refs.
